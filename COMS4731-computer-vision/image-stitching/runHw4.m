...
signAcademicHonestyPolicy('Xucheng Chen', 'xc2360');
...
ransac_eps = 4; % Acceptable alignment error 
...
% Your own panorama
imgl = im2single(imread('Bear_left.png'));
imgc = im2single(imread('Bear_center.png'));
imgr = im2single(imread('Bear_right.png'));

% You are free to change the order of input arguments
stitched_img = stitchImg(imgl, imgc, imgr);
%figure, imshow(stitched_img);
imwrite(stitched_img, 'Bear_panorama.png');
