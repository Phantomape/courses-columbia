...
%
%               Default: 6
%   different values of these two parameters make significant impact on 
%   the result. Here are some params proves to be generating better results
%   in the experiment.
%   Img1:   nhood = size(H)/25, fillgap = 15, minlength = 6
%           rho_num_bins = 1537;theta_num_bins = 180;
%   Img2:   nhood = size(H)/500; fillgap = 15, minlength = 6
%           rho_num_bins = 1597;theta_num_bins = 180;
%   Img3:	nhood = size(H)/800; fillgap = 15, minlength = 6
%           rho_num_bins = 1593;theta_num_bins = 180;
%
%	More info about the code please visit:
%	http://phantomape.github.io/
